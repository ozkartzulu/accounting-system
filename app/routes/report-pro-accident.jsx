...
import { getProAccident } from '~/models/partners.server'
...
export async function loader(){
    const partners = await getProAccident()
    return partners
}

function ReportProAccident(){
    ...
    const getTotal = () => partners.reduce( (total, row) => total + row.pro_accident.amount, 0 )
    ...
    return (
        ...
        <main className='container mx-auto'>
            <h2 className='text-3xl text-indigo-900 font-bold text-center mb-5'>Reporte Pro Accident</h2>
...
export default ReportProAccident