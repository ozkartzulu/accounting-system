...
import { getProFurniture } from '~/models/partners.server'
...
export async function loader(){
    const partners = await getProFurniture()
    return partners
}

function ReportProFurniture(){
    ...
    const getTotal = () => partners.reduce( (total, row) => total + row.pro_furniture.amount, 0 )
    ...
    return (
        ...
        <main className='container mx-auto'>
            <h2 className='text-3xl text-indigo-900 font-bold text-center mb-5'>Reporte Pro Mobiliario</h2>
...
export default ReportProFurniture