...
export async function action({request}){
    ...
    await addDeport(data)

    return redirect('/report-pro-deport')
}

function ReportProDeport(){
    ...
    return (
        <main className='container mx-auto'>
            <h2 className='text-3xl text-indigo-900 font-bold text-center mb-5'>Reporte Pro Deporte</h2>
            <div className='mb-4'>
                <ul>
                    <SubMenu errors={errors} >{'Agregar Pro-Deporte'}</SubMenu>
                </ul>
            </div>
            { allData.length > 0 ?
            ...
            :
            <div className='text-xl'>No hay Ninguna registro de Pro Deporte aún</div>
            }
        </main>
    )
}

export default ReportProDeport