...
function ReportAir(){
    ...
    return (
        <main className='container mx-auto'>
            <h2 className='text-3xl text-indigo-900 font-bold text-center mb-5'>Reporte Aire</h2>
            <div className='mb-4'>
                <ul>
                    <SubMenu errors={errors} >{'Agregar Aire'}</SubMenu>
                </ul>
            </div>
            { allData.length > 0 ?
            ...
            :
            <div className='text-xl'>No hay Ninguna registro de Aire agregado aún</div>
            }
        </main>
    )
}

export default ReportAir